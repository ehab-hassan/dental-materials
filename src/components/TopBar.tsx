...
export default function TopBar() {
  return (
    <div className="fixed left-0 right-0 top-0 z-[60] border-b border-white/20 bg-[#0e7490] px-4 py-2 text-sm text-white/90">
      <div className="mx-auto flex max-w-7xl items-center justify-between sm:px-6 lg:px-8">
        <div className="flex items-center gap-6">
          <a href="tel:+201002127559" className="hover:text-white transition-colors">
            +20 100 212 7559
          </a>
          <a href="mailto:info@acrostone.com" className="hover:text-white transition-colors">
            info@acrostone.com
          </a>
        </div>
